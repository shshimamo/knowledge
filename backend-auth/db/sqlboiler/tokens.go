...
type Token struct {
	...
	AuthUserID int64     `boil:"auth_user_id" json:"auth_user_id" toml:"auth_user_id" yaml:"auth_user_id"`
...
var TokenTableColumns = struct {
	...
	ID:         "tokens.id",
	AuthUserID: "tokens.auth_user_id",
	Token:      "tokens.token",
...
var TokenWhere = struct {
	...
	AuthUserID: whereHelperint64{field: "\"tokens\".\"auth_user_id\""},
	Token:      whereHelperstring{field: "\"tokens\".\"token\""},
	Active:     whereHelperbool{field: "\"tokens\".\"active\""},
...
var (
	tokenAllColumns            = []string{"id", "auth_user_id", "token", "active", "expires_at", "created_at", "updated_at"}
	tokenColumnsWithoutDefault = []string{"auth_user_id", "token", "expires_at"}
	tokenColumnsWithDefault    = []string{"id", "active", "created_at", "updated_at"}
...
func (q tokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Token, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: failed to execute a one query for tokens")
	}
...
func (q tokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (TokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db: failed to assign all query results to Token slice")
	}
...
func (q tokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to count tokens rows")
	}
...
func (q tokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db: failed to check if tokens exists")
	}
...
func FindToken(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Token, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: unable to select from tokens")
	}
...
func (o *Token) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db: no tokens provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to insert into tokens")
	}
...
func (o *Token) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update tokens, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update tokens row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for tokens")
	}
...
func (q tokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for tokens")
	}
...
func (o TokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in token slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all token")
	}
	return rowsAff, nil
}
...
func (o *Token) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db: no tokens provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db: unable to upsert tokens, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert tokens")
	}
...
func (o *Token) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no Token provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for tokens")
	}
...
func (q tokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no tokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for tokens")
	}
...
func (o TokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from token slice")
	}
...
func (o *TokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to reload all in TokenSlice")
	}
...
func TokenExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db: unable to check if tokens exists")
	}
