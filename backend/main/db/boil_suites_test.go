...
func TestToOne(t *testing.T) {
	t.Run("KnowledgeToUserUsingUser", testKnowledgeToOneUserUsingUser)
}
...
func TestToMany(t *testing.T) {
	t.Run("UserToKnowledges", testUserToManyKnowledges)
}

// TestToOneSet tests cannot be run in parallel
// or deadlocks can occur.
func TestToOneSet(t *testing.T) {
	t.Run("KnowledgeToUserUsingKnowledges", testKnowledgeToOneSetOpUserUsingUser)
}
...
func TestToManyAdd(t *testing.T) {
	t.Run("UserToKnowledges", testUserToManyAddOpKnowledges)
}
