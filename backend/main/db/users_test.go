...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `AuthUserID`: `bigint`, `Name`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
